                ...
                <div className="data w-full max-w-xl">
                  ...
                  <div className="flex flex-col gap-4 w-full max-w-md mx-auto p-4">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        {/* Add to Cart Button */}
                        <button onClick={handleIncrement} className="flex items-center gap-2 bg-indigo-100 text-customGreen font-semibold rounded-full px-6 py-3 hover:bg-indigo-200 transition">
