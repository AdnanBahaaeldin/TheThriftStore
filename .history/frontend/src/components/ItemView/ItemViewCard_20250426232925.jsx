...
function ItemViewCard() {
    ...
    return (
        <section className="relative">
          ...
          <div className="w-3/4 mx-auto px-4 sm:px-6 lg:px-0 rounded-md border-gray-300 border bg-white mt-10 mb-10">
            <h2 className="text-2xl font-semibold mb-4">Customer Reviews</h2>

            {/* Overall rating */}
            <div className="flex items-center gap-2 mb-6">
                <div className="flex text-yellow-400">
                {/* Render 4 full stars and 1 empty star manually or dynamically */}
                ★★★★☆
                </div>
                <p className="text-gray-600">Based on 1624 reviews</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                {[5, 4, 3, 2, 1].map((star, idx) => (
                    ...
                    <div className="w-full bg-gray-200 h-2 rounded overflow-hidden">
                        ...
                        style={{ width: star === 5 ? '63%' : star === 4 ? '10%' : star === 3 ? '6%' : star === 2 ? '12%' : '9%' }}
                        ></div>
                    </div>
                    <span className="text-gray-600 text-sm">{star === 5 ? '63%' : star === 4 ? '10%' : star === 3 ? '6%' : star === 2 ? '12%' : '9%'}</span>
                    </div>
                ))}
