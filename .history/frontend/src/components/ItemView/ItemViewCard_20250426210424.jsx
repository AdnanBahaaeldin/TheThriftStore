...
function ItemViewCard() {
    ...
    return (
      ...
      <div className="flex items-center gap-4">
        ...
        {/* Add to Cart Button */}
        <button className="flex items-center gap-2 bg-indigo-100 text-indigo-600 font-semibold rounded-full px-6 py-3 hover:bg-indigo-200 transition">
      ...
      <div className="flex items-center gap-4">
        {/* Heart Icon */}
        <button className="p-3 rounded-full bg-indigo-100 text-indigo-600 hover:bg-indigo-200 transition">
